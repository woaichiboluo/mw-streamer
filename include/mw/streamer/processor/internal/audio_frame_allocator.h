#ifndef MW_STREAMER_PROCESSOR_INTERNAL_AUDIO_FRAME_ALLOCATOR_H_
#define MW_STREAMER_PROCESSOR_INTERNAL_AUDIO_FRAME_ALLOCATOR_H_
...
#endif  // MW_STREAMER_PROCESSOR_INTERNAL_AUDIO_FRAME_ALLOCATOR_H_
