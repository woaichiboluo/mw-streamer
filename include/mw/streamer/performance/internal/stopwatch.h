#ifndef MW_STREAMER_PERFORMANCE_INTERNAL_STOPWATCH_H_
#define MW_STREAMER_PERFORMANCE_INTERNAL_STOPWATCH_H_
...
#endif  // MW_STREAMER_PERFORMANCE_INTERNAL_STOPWATCH_H_
