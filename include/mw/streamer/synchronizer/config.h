#ifndef MW_STREAMER_SYNCHRONIZER_CONFIG_H_
#define MW_STREAMER_SYNCHRONIZER_CONFIG_H_
...
struct SynchronizerSinkConfig {
  ...
  std::chrono::milliseconds max_frame_lateness_ms{100};
  std::chrono::milliseconds standby_timeout_ms{500};
...
#endif  // MW_STREAMER_SYNCHRONIZER_CONFIG_H_
