#ifndef MW_STREAMER_SYNCHRONIZER_SYNCHRONIZER_SINK_H_
#define MW_STREAMER_SYNCHRONIZER_SYNCHRONIZER_SINK_H_
...
#endif  // MW_STREAMER_SYNCHRONIZER_SYNCHRONIZER_SINK_H_
